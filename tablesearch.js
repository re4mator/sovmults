function searchTable(input, tableId, searchColumn = -1, searchColumn2 = -1, searchColumn4 = -1) 
{
	...
	for (var i = 0, row; row = table.rows[i]; i++) {
		...
		else
		{
			if (i != 0)	{	//don't perform search on the first row header
				...
				if (searchColumn4 != -1) {	//4 category search
					...
					rowText3 = row.cells[searchColumn4].innerHTML;	//get text for the 4rd column
